...
class FunstreamTv extends StreamService {

    const CHECK_STREAM_STATUS_URL = 'http://player.funstream.tv/api/client/status/c';
    ...
    public function getEmbedPlayerCode($channel, $width, $height) {
        return $this->renderTemplate('player/funstreamtv', array('channelName' => $channel['name'], 'width' => $width, 'height' => $height));
    }
